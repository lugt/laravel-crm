<form action="{{isset($route)?$route:route('customers.store')}}" method="POST" >
    ...
    <input type="hidden" name="_method" value="{{isset($method)?$method:'POST'}}"/>
        ...
        <input type="text" class="form-control {{ $errors->has('cname') ? ' is-invalid' : '' }}" name="cname" id="cname" value="{{old('cname',$model->cname)}}" placeholder="" maxlength="150" >
          @if($errors->has('cname'))
  ...
  @endif
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control {{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" id="city" value="{{old('city',$model->city)}}" placeholder="" maxlength="150" >
          @if($errors->has('city'))
    <div class="invalid-feedback">
